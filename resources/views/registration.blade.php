...
<body>
            ...
            <div class="modal-content">
                ...
                <form id="UpdateEmployeeForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <input type="text" name="firstname" id="edit_firstname" class="form-control" placeholder="First Name" value="{{old('firstname')}}">
                        </div>
                        <div class="form-group mb-3">
                            <input type="text" name="lastname" id="edit_lastname" class="form-control" placeholder="Last Name" value="{{old('lastname')}}">
                        </div>
                        <div class="form-group mb-3">
                            <input type="text" name="email" id="edit_email" class="form-control" placeholder="Email" value="{{old('email')}}">
                        </div>
                        <div class="form-group mb-3">
                            <input type="text" name="mobile" id="edit_mobile" class="form-control" placeholder="Mobile" value="{{old('mobile')}}">
                        </div>
                        <div class="form-group mb-3">
    ...
    <div class="container-xxl position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0 let">
            <a href="{{url('registration')}}" class="navbar-brand p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0 pe-4">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown"><i class="fa fa-user me-3"></i>{{session()->get('firstname')}} {{session()->get('lastname')}}</a>
